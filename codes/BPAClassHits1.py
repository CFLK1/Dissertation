...
input = "./norange/FULL_extracted_norange_withPaths.csv" # only for MUSHv2 now

df = pd.read_csv(input, index_col=0)

output = "./norange/FULL_inPGroup_hitsAt1_norange.csv"
...
################################################################################
    ...
    hitsAt1 = [set for set in scoreChunk if "score.set.TST.rel.inPGroup.tail.hits@1" in set]

    # split chunk of text into distinct values
    hitsAt1 = hitsAt1[0].split(" = ")
    hitsAt1 = ["inPGroupHitsAt1"] + [hitsAt1[1]]
