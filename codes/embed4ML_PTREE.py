...
input = "./norange/PTREEv2_extracted_norange_withPaths.csv" # only for MUSHv2 now

df = pd.read_csv(input, index_col=0)

# excel for labelled data:
labels = "./norange/PTREE_labels.csv"
...
################################################################################
    ...
    sampleTable = entityTable[entityTable.iloc[:,0].str.contains("POrgForm:")]
...
################################################################################
    ...
    sampleTable["class"] = label_df["pgroup"]
