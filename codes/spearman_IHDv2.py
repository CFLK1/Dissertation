...
def spearman_r(data, output):
    ...
    for dat in dflist:
        ...
        r5 = stats.spearmanr(dat["inSocialGroupHitsAt5"], dat["MLP_acc"])[0]
        r6 = stats.spearmanr(dat["inSocialGroupHitsAt5"], dat["MLP_wF1"])[0]
        results.append([r1, r2, r3, r4, r5, r6])

    colnames = ["mrr_acc", "mrr_wF1", "mrank_acc", "mrank_wF1", "relH5_acc", \
                "relH5_wF1"]
...
spearman_r(data = "./norange/new_remain/IHDv2_jointable_norange.csv", \
          output = "./norange/new_remain/IHDv2_spearmanr_norange.csv")
