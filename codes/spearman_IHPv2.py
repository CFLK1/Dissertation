...
def spearman_r(data, output):
    ...
    for dat in dflist:
        ...
        r5 = stats.spearmanr(dat["hadAbortionHitsAt1"], dat["MLP_acc"])[0]
        r6 = stats.spearmanr(dat["hadAbortionHitsAt1"], dat["MLP_wF1"])[0]
...
spearman_r(data = "./norange/new_remain/IHPv2_jointable_norange.csv", \
          output = "./norange/new_remain/IHPv2_spearmanr_norange.csv")
